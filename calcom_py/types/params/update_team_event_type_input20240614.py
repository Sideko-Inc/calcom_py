...
class UpdateTeamEventTypeInput20240614(typing_extensions.TypedDict):
    """
    ...
    hosts: typing_extensions.NotRequired[typing.List[Host]]
...
class _SerializerUpdateTeamEventTypeInput20240614(pydantic.BaseModel):
    """
    Serializer for UpdateTeamEventTypeInput20240614 handling case conversions
    ...
    hosts: typing.Optional[typing.List[_SerializerHost]] = pydantic.Field(
        alias="hosts", default=None
    )
