...
class TitleDefaultFieldInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerTitleDefaultFieldInput20240614(pydantic.BaseModel):
    """
    Serializer for TitleDefaultFieldInput20240614 handling case conversions
