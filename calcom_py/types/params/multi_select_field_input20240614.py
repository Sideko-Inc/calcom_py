...
class MultiSelectFieldInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerMultiSelectFieldInput20240614(pydantic.BaseModel):
    """
    Serializer for MultiSelectFieldInput20240614 handling case conversions
