...
class CreateOrgTeamDto(typing_extensions.TypedDict):
    """
    CreateOrgTeamDto
    """
...
class _SerializerCreateOrgTeamDto(pydantic.BaseModel):
    """
    Serializer for CreateOrgTeamDto handling case conversions
