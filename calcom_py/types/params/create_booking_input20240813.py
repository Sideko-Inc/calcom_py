...
class CreateBookingInput20240813(typing_extensions.TypedDict):
    """
...
class _SerializerCreateBookingInput20240813(pydantic.BaseModel):
    """
    Serializer for CreateBookingInput20240813 handling case conversions
