...
class BusinessDaysWindow20240614(typing_extensions.TypedDict):
    """
...
class _SerializerBusinessDaysWindow20240614(pydantic.BaseModel):
    """
    Serializer for BusinessDaysWindow20240614 handling case conversions
