...
class TextAreaFieldInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerTextAreaFieldInput20240614(pydantic.BaseModel):
    """
    Serializer for TextAreaFieldInput20240614 handling case conversions
