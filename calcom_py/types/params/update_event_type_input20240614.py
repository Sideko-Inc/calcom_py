...
class UpdateEventTypeInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerUpdateEventTypeInput20240614(pydantic.BaseModel):
    """
    Serializer for UpdateEventTypeInput20240614 handling case conversions
