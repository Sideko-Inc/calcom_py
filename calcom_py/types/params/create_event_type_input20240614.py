...
class CreateEventTypeInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerCreateEventTypeInput20240614(pydantic.BaseModel):
    """
    Serializer for CreateEventTypeInput20240614 handling case conversions
