...
class SelectFieldInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerSelectFieldInput20240614(pydantic.BaseModel):
    """
    Serializer for SelectFieldInput20240614 handling case conversions
