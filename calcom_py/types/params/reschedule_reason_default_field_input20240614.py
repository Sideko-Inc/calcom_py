...
class RescheduleReasonDefaultFieldInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerRescheduleReasonDefaultFieldInput20240614(pydantic.BaseModel):
    """
    Serializer for RescheduleReasonDefaultFieldInput20240614 handling case conversions
