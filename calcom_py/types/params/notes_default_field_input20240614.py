...
class NotesDefaultFieldInput20240614(typing_extensions.TypedDict):
    """
...
class _SerializerNotesDefaultFieldInput20240614(pydantic.BaseModel):
    """
    Serializer for NotesDefaultFieldInput20240614 handling case conversions
