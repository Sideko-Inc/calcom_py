...
from .event_type_team import EventTypeTeam
...
from .team_event_type_response_host import TeamEventTypeResponseHost
...
class TeamEventTypeOutput20240614(pydantic.BaseModel):
    """
    ...
    forward_params_success_redirect: typing.Optional[bool] = pydantic.Field(
    ...
    hosts: typing.List[TeamEventTypeResponseHost] = pydantic.Field(
        alias="hosts",
    )
    ...
    owner_id: typing.Optional[float] = pydantic.Field(alias="ownerId", default=None)
    parent_event_type_id: typing.Optional[float] = pydantic.Field(
        alias="parentEventTypeId", default=None
    )
    """
    ...
    seats_per_time_slot: typing.Optional[float] = pydantic.Field(
    ...
    team: EventTypeTeam = pydantic.Field(
        alias="team",
    )
