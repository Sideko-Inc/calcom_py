...
class EventTypesClient:
    ...
    def delete(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.delete(
            event_type_id=123.0, org_id=123.0, team_id=123.0
        )
        ```
        """
        return self._base_client.request(
            method="DELETE",
            path=f"/v2/organizations/{org_id}/teams/{team_id}/event-types/{event_type_id}",
    ...
    def list_for_team(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.list_for_team(org_id=123.0)
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v2/organizations/{org_id}/teams/event-types",
            auth_names=["bearerAuth"],
            query_params=_query,
    ...
    def list(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.list(org_id=123.0, team_id=123.0)
        ```
        """
        _query: QueryParams = {}
        ...
        return self._base_client.request(
            method="GET",
            path=f"/v2/organizations/{org_id}/teams/{team_id}/event-types",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.GetTeamEventTypesOutput,
            request_options=request_options or default_request_options(),
    ...
    def get_one(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.get_one(
            event_type_id=123.0, org_id=123.0, team_id=123.0
        )
        ```
        """
    ...
    def patch(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.patch(
            event_type_id=123.0,
            org_id=123.0,
            team_id=123.0,
    ...
    def create(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.create(
            hosts=[{"user_id": 123.0}],
            length_in_minutes=60.0,
            org_id=123.0,
    ...
    def create_phone_call(
        ...
        *,
        ...
        Examples:
        ```py
        client.organizations.teams.event_types.create_phone_call(
            cal_api_key="string",
            enabled={},
            event_type_id=123.0,
        ...
        return self._base_client.request(
            method="POST",
            path=f"/v2/organizations/{org_id}/teams/{team_id}/event-types/{event_type_id}/create-phone-call",
            auth_names=["bearerAuth"],
            json=_json,
...
class AsyncEventTypesClient:
    ...
    async def delete(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.delete(
            event_type_id=123.0, org_id=123.0, team_id=123.0
        )
        ```
        """
    ...
    async def list_for_team(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.list_for_team(org_id=123.0)
        ```
        """
        _query: QueryParams = {}
        if not isinstance(skip, type_utils.NotGiven):
    ...
    async def list(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.list(org_id=123.0, team_id=123.0)
        ```
        """
        _query: QueryParams = {}
        if not isinstance(event_slug, type_utils.NotGiven):
    ...
    async def get_one(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.get_one(
            event_type_id=123.0, org_id=123.0, team_id=123.0
        )
        ```
        """
    ...
    async def patch(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.patch(
            event_type_id=123.0,
            org_id=123.0,
            team_id=123.0,
            custom_name="{Event type title} between {Organiser} and {Scheduler}",
    ...
    async def create(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.create(
            hosts=[{"user_id": 123.0}],
            length_in_minutes=60.0,
            org_id=123.0,
            scheduling_type="collective",
    ...
    async def create_phone_call(
        ...
        *,
        ...
        Examples:
        ```py
        await client.organizations.teams.event_types.create_phone_call(
            cal_api_key="string",
            enabled={},
            event_type_id=123.0,
            number_to_call="string",
