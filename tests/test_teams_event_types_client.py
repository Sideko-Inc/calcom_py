...
def test_create_201_success_default():
    """Tests a POST request to the /v2/teams/{teamId}/event-types endpoint.
    ...
    response = client.teams.event_types.create(
...
async def test_await_create_201_success_default():
    ...
    response = await client.teams.event_types.create(
        hosts=[{"user_id": 123.45}],
        length_in_minutes=60.0,
        scheduling_type="collective",
        slug="learn-the-secrets-of-masterchief",
...
def test_patch_200_success_default():
    """Tests a PATCH request to the /v2/teams/{teamId}/event-types/{eventTypeId} endpoint.
    ...
    # tests calling sync method with example data
    client = Client(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = client.teams.event_types.patch(
...
async def test_await_patch_200_success_default():
    ...
    # tests calling async method with example data
    client = AsyncClient(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = await client.teams.event_types.patch(
        event_type_id=123.45,
        team_id=123.45,
        custom_name="{Event type title} between {Organiser} and {Scheduler}",
        description="Discover the culinary wonders of the Argentina by making the best flan ever!",
...
def test_get_200_generated_success():
    """Tests a GET request to the /v2/teams/{teamId}/event-types/{eventTypeId} endpoint.
    ...
    # tests calling sync method with example data
    client = Client(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = client.teams.event_types.get(event_type_id=123.45, team_id=123.45)
    try:
...
async def test_await_get_200_generated_success():
    ...
    # tests calling async method with example data
    client = AsyncClient(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = await client.teams.event_types.get(event_type_id=123.45, team_id=123.45)
    try:
        pydantic.TypeAdapter(models.GetTeamEventTypeOutput).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_list_200_generated_success():
    """Tests a GET request to the /v2/teams/{teamId}/event-types endpoint.
    ...
    # tests calling sync method with example data
    client = Client(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = client.teams.event_types.list(team_id=123.45)
    try:
...
async def test_await_list_200_generated_success():
    ...
    # tests calling async method with example data
    client = AsyncClient(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = await client.teams.event_types.list(team_id=123.45)
    try:
        pydantic.TypeAdapter(models.GetTeamEventTypesOutput).validate_python(response)
        is_json = True
    except pydantic.ValidationError:
...
def test_delete_200_generated_success():
    """Tests a DELETE request to the /v2/teams/{teamId}/event-types/{eventTypeId} endpoint.
    ...
    # tests calling sync method with example data
    client = Client(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = client.teams.event_types.delete(event_type_id=123.45, team_id=123.45)
    try:
...
async def test_await_delete_200_generated_success():
    ...
    # tests calling async method with example data
    client = AsyncClient(api_key="API_TOKEN", environment=Environment.MOCK_SERVER)
    response = await client.teams.event_types.delete(
        event_type_id=123.45, team_id=123.45
    )
    try:
        pydantic.TypeAdapter(models.DeleteTeamEventTypeOutput).validate_python(response)
        is_json = True
