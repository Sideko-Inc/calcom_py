...
def test_list_200_generated_success():
    """Tests a GET request to the /v2/organizations/{orgId}/teams/{teamId}/users/{userId}/schedules endpoint.
    ...
    response = client.organizations.teams.users.schedules.list(
...
async def test_await_list_200_generated_success():
    ...
    response = await client.organizations.teams.users.schedules.list(
        org_id=123.45, team_id=123.45, user_id=123.45
    )
    try:
        pydantic.TypeAdapter(models.GetSchedulesOutput20240611).validate_python(
